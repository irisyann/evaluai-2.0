<template>
    <v-card max-width="700px" width="100%" class="mx-auto" flat style="background: transparent;">
        ...
        <v-card-text class="py-5">
            ...
            <v-btn :loading="loadingGenerate" @click="getInputs" class="mx-auto ml-5" style="width: 95%" color="secondary">Generate questions</v-btn>
        </v-card-text>
    </v-card>
</template>
                ...
                await instance.post('/completions', {
                    ...
                    await instance.post('/completions', {
                        ...
                        window.dispatchEvent(new CustomEvent('evaluai_localstorage_changed', {
                            detail: {
                                generatedQuestions: localStorage.getItem('evaluai_generatedQuestions'),
